...
- [Provider source](https://github.com/okta/terraform-provider-okta/blob/master/okta/services/idaas/resource_okta_app_signon_policy_rule.go)
...
- `chains` (List of String) Use with verification method = `AUTH_METHOD_CHAIN` only
