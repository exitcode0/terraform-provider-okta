...
- [Okta API docs](https://developer.okta.com/docs/api/openapi/okta-management/management/tag/InlineHook/)
- [Provider source](https://github.com/okta/terraform-provider-okta/blob/master/okta/services/idaas/resource_okta_inline_hook.go)
...
- `channel_json` (String) true channel object for the inline hook API contract
