...
- [Provider source](https://github.com/okta/terraform-provider-okta/blob/master/okta/services/idaas/resource_okta_app_basic_auth.go)
...
- `user_name_template_push_status` (String) Push username on update. Valid values: `PUSH`, `DONT_PUSH` and `NOT_CONFIGURED`
- `user_name_template_suffix` (String) Username template suffix
- `user_name_template_type` (String) Username template type. Default: `BUILT_IN`. Valid values: `NONE`, `CUSTOM`, `BUILT_IN`
