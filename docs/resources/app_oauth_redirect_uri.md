...
- [Provider source](https://github.com/okta/terraform-provider-okta/blob/master/okta/services/idaas/resource_okta_app_oauth_redirect_uri.go)
- [SDK source](https://github.com/okta/terraform-provider-okta/blob/master/sdk/api_application.go)
